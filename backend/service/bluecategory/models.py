...
class client(models.Model):
	...
	childrens = models.CharField(max_length=50, default="0")
	year = models.CharField(max_length=50 , default='Desconoce')
...
class childrens(models.Model):
	register = models.CharField(max_length=500, default='nobase')
	sex = models.CharField(max_length=50, default='nochildren_sex')
	age = models.CharField(max_length=50, default='nochildren_age')
	date = models.DateTimeField(auto_now_add=True)
	@property
	def created_tz(self):
		return localize_datetime(self.date)
...
class vendor(models.Model):
	...
	isapre = models.CharField(max_length=1000 ,default='noisapre')
	...
	link = models.CharField(max_length=1000 ,default='oportunidades')
	@property
	def created_tz(self):
		return localize_datetime(self.date)
...
class clinics(models.Model):
	base = models.CharField(max_length=500, default='nobase')
	clinic = models.CharField(max_length=50, default='noclinic')
	date = models.DateTimeField(auto_now_add=True)
	@property
	def created_tz(self):
		return localize_datetime(self.date)
...
class preference(models.Model):
	base = models.CharField(max_length=500, default='nobase')
	preference = models.CharField(max_length=50, default='nopreference')
	date = models.DateTimeField(auto_now_add=True)
	@property
	def created_tz(self):
		return localize_datetime(self.date)
...
class filter(models.Model):
	base = models.CharField(max_length=500, default='nobase')
	childrens = models.CharField(max_length=500, default='nochildrens')
	investment = models.CharField(max_length=500, default='noinvestment')
	region = models.CharField(max_length=500, default='noregion')
	commune = models.CharField(max_length=500, default='nocommune')
	gender = models.CharField(max_length=500, default='nogender')
